...
def publish_ride_view():
    if request.method == 'POST':
        ...
        if category == "one-time":
            ...
            available_seats_per_date = json.dumps({"seats": available_seats})  
...
# Routes for booking a joureny by teh user/passenger
...
def book_journey(ride_id):
    ...
    if ride.available_seats_per_date:
        try:
            seat_data = json.loads(ride.available_seats_per_date)  
        except json.JSONDecodeError:
            seat_data = {}  
